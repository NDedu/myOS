...
-- Deliberately not CTRL + ALT + DELETE: that chord is muscle memory for "reboot" elsewhere,
-- and this closes every window without asking. Also run by logout/reboot/shutdown.sh.
o.bind("CTRL + SHIFT + ALT + Delete", "Close all windows", o.script("window-close-all.sh"))

o.bind("SUPER + J", "Toggle window split", hl.dsp.layout("togglesplit"))
o.bind("SUPER + P", "Pseudo window", hl.dsp.window.pseudo())
o.bind("SUPER + T", "Toggle window floating/tiling", hl.dsp.window.float({ action = "toggle" }))
o.bind("SUPER + F", "Full screen", hl.dsp.window.fullscreen({ mode = "fullscreen" }))
o.bind("SUPER + CTRL + F", "Tiled full screen", o.script("window-tiled-fullscreen.sh"))
o.bind("SUPER + ALT + F", "Full width", hl.dsp.window.fullscreen({ mode = "maximized" }))
o.bind("SUPER + O", "Pop window out (float & pin)", o.script("window-pop.sh"))
o.bind("SUPER + ALT + Home", "Save window width", o.script("window-width.sh", "save"))
o.bind("SUPER + Home", "Restore window width", o.script("window-width.sh", "restore"))
o.bind("SUPER + L", "Toggle workspace layout", o.script("workspace-layout-toggle.sh"))
...
o.bind("ALT + TAB", nil, hl.dsp.window.bring_to_top())
o.bind("ALT + SHIFT + TAB", nil, hl.dsp.window.bring_to_top())
...
-- code:20 is the minus key, code:21 the equal key
...
o.bind("SUPER + SLASH", "Monitor scaling up", o.script("monitor-scaling.sh", "up"))
o.bind("SUPER + ALT + SLASH", "Monitor scaling down", o.script("monitor-scaling.sh", "down"))
