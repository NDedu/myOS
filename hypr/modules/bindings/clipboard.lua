-- Universal copy/paste: SUPER + C/V/X work the same in every app, terminals included.
--
...
-- Terminals are tagged in windows.lua. Dynamic tags carry a trailing "*".
...
o.bind("SUPER + CTRL + V", "Clipboard manager", o.script("clipboard.sh"))
